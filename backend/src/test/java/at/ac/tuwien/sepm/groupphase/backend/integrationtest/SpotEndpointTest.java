...
public class SpotEndpointTest implements TestData {
    ...
    public void getSpotsByLocationTest() {
        ...
        List<SpotDto> spots = spotEndpoint.findAll(location.getId(), null, null);
        assertAll(
    ...
    public void getSpotsByLocationTestWithWrongLocation() {
        ...
        Throwable e = assertThrows(ResponseStatusException.class, () -> spotEndpoint.findAll(id, null, null));
        assertAll(
